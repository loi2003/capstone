  ...
  return (
    <header className="health-expert-header">
      <div className="container">
        <Link to="/health-expert" className="logo">
          <motion.svg
        ...
        <nav className={isMenuOpen ? 'block' : ''}>
          <Link to="/health-expert/consultations">Consultations</Link>
          <Link to="/health-expert/support">Support</Link>
          <Link to="/health-expert/profile">Profile</Link>
          {user ? (
            <div className="health-expert-profile-section">
              <button
                className="health-expert-profile-toggle"
              ...
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    fill="var(--health-expert-color4)"
                  />
                </svg>
              </button>
              {isDropdownOpen && (
                <div className="health-expert-profile-dropdown">
