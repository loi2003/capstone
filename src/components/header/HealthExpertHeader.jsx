...
import '../../styles/HealthExpertHeader.css';

const HealthExpertHeader = () => {
  ...
  return (
    <header className="health-expert-header">
      <div className="container">
        <Link to="/health-expert" className="logo" aria-label="Health Expert Panel Home">
          <motion.svg
          ...
          >
            ...
            <path
              ...
              stroke="var(--health-expert-green)"
              strokeWidth="1.5"
              strokeLinecap="round"
            ...
            <path
              ...
              stroke="var(--health-expert-orange)"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
          </motion.svg>
          <span>Health Expert Panel</span>
        </Link>
        <button
        ...
        <nav className={isMenuOpen ? 'block' : ''} aria-label="Main navigation">
          <Link to="/health-expert/consultations" onClick={() => setIsMenuOpen(false)}>Consultations</Link>
          <Link to="/health-expert/support" onClick={() => setIsMenuOpen(false)}>Support</Link>
          <Link to="/health-expert/profile" onClick={() => setIsMenuOpen(false)}>Profile</Link>
          {user ? (
...
export default HealthExpertHeader;