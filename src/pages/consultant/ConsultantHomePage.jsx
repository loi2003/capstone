    ...
    <div className="consultant-homepage">
      ...
      >
        <div className="sidebar-header">
          <Link to="/consultant" className="logo" onClick={() => setIsSidebarOpen(true)}>
            <motion.div
            ...
            {isSidebarOpen && <span className="logo-text">Consultant Panel</span>}
          </Link>
        ...
        >
          <motion.div variants={navItemVariants} className="sidebar-nav-item">
            <Link to="/consultant/dashboard" onClick={() => setIsSidebarOpen(true)} title="Dashboard">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
          ...
          <motion.div variants={navItemVariants} className="sidebar-nav-item">
            <Link to="/consultant/schedule" onClick={() => setIsSidebarOpen(true)} title="Schedule">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
          ...
          <motion.div variants={navItemVariants} className="sidebar-nav-item">
            <Link to="/consultant/clients" onClick={() => setIsSidebarOpen(true)} title="Clients">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
          ...
          <motion.div variants={navItemVariants} className="sidebar-nav-item">
            <Link to="/consultant/support" onClick={() => setIsSidebarOpen(true)} title="Support">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
          ...
          {user ? (
            <>
              <motion.div variants={navItemVariants} className="sidebar-nav-item consultant-profile-section">
                <div className="consultant-profile-info" title={isSidebarOpen ? user.email : ''}>
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                  ...
                  {isSidebarOpen && <span className="consultant-profile-email">{user.email}</span>}
                </div>
              </motion.div>
              <motion.div variants={navItemVariants} className="sidebar-nav-item">
                <button
