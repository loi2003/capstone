    ...
    <section className="homepage-section">
      <header className="homepage-header">
        ...
        <nav className="homepage-nav">
          <Link to="/admin/users" className="homepage-nav-link">Quản lý người dùng</Link>
          <Link to="/admin/reports" className="homepage-nav-link">Báo cáo</Link>
          <Link to="/admin/settings" className="homepage-nav-link">Cài đặt</Link>
      ...
      >
        <h1 className="homepage-title">Bảng Điều Khiển Quản Trị</h1>
        <p className="homepage-description">
          Chào mừng đến với bảng điều khiển quản trị. Quản lý người dùng, xem báo cáo, và điều chỉnh cài đặt hệ thống.
        </p>
        <div className="homepage-cards">
          <div className="homepage-card">
            <h2>Quản lý người dùng</h2>
            <p>Xem và chỉnh sửa thông tin người dùng, phân quyền, và quản lý tài khoản.</p>
            <Link to="/admin/users" className="homepage-card-link">Khám phá</Link>
          </div>
          <div className="homepage-card">
            <h2>Báo cáo</h2>
            <p>Phân tích dữ liệu, theo dõi hoạt động, và tạo báo cáo chi tiết.</p>
            <Link to="/admin/reports" className="homepage-card-link">Khám phá</Link>
          </div>
          <div className="homepage-card">
            <h2>Cài đặt</h2>
            <p>Điều chỉnh cấu hình hệ thống, tích hợp, và tùy chỉnh nền tảng.</p>
            <Link to="/admin/settings" className="homepage-card-link">Khám phá</Link>
          </div>
        </div>
      </motion.div>
    </section>
