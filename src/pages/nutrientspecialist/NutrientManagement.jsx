...
const NutrientManagement = () => {
  ...
  const [newNutrient, setNewNutrient] = useState({ name: "", categoryId: "", description: "" });
  ...
  const fetchNutrientById = async (id) => {
    ...
    try {
      ...
      setNewNutrient({ name: data.name, categoryId: data.categoryId, description: data.description });
      setIsEditing(true);
    } catch (err) {
  ...
  const createNewNutrient = async () => {
    ...
    if (nutrients.some((nut) => nut.name.toLowerCase() === newNutrient.name.trim().toLowerCase())) {
  ...
  useEffect(() => {
    if (chartInstanceRef.current) {
      ...
      chartInstanceRef.current.data.labels = categoryCounts.map((cat) => cat.name);
      chartInstanceRef.current.data.datasets[0].data = categoryCounts.map((cat) => cat.count);
      ...
      >
        <div className="management-header">
          <div className="header-content">
            ...
            <p>
              Create, edit, and manage nutrients for better organization
            </p>
          </div>
        </div>
            ...
            <div className="form-card">
              <div className="form-group">
                ...
                <div className="button-group">
                  <motion.button
                    onClick={isEditing ? updateExistingNutrient : createNewNutrient}
                    disabled={loading}
                    ...
                    >
                      <div className="card-header">
                        ...
                        <div className="category-badge">
                          {categories.find((cat) => cat.id === nutrient.categoryId)?.name || "No Category"}
                        </div>
                      </div>
