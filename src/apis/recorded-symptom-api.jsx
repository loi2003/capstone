...
export const updateCustomSymptom = async (symptomId, updatedData, token) => {
  try {
    ...
    console.log('Updated template symptom:', response.data);
    return response;
  } catch (error) {
...
export const markTemplateSymptomAsChecked = async (symptomId, token) => {
  try {
    ...
    console.log('Marked template symptom as checked:', response.data);
    return response;
  } catch (error) {
...
export const deleteRecordedSymptom = async (symptomId, token) => {
  try {
    ...
    console.log('Deleted recorded symptom:', response.data);
    return response;
  } catch (error) {
